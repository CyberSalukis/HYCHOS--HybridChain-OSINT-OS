...
from .crypto import sha256_json, sign, verify
from .block import Block

class PublicBlock:
    """
    Public blockchain block containing only verification data.
    Links to private chain without exposing sensitive evidence.
    """
...
class HybridChain:
    """
    Manages the hybrid blockchain architecture with both private and public layers.
    
    The private layer stores full evidence with access controls.
    The public layer stores verification metadata for transparency and community validation.
    """
